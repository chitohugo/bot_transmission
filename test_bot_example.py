...
def start(update: Update, _: CallbackContext) -> int:
    ...
    keyboard = [
        [
            InlineKeyboardButton(text="Add", callback_data=str(ONE)),
            InlineKeyboardButton("Search", callback_data=str(TWO)),
            InlineKeyboardButton("List", callback_data=str(TWO)),
        ]
    ]
...
def main() -> None:
    ...
    updater = Updater("1630806011:AAF6Igp28SBXuz5Jmvzs4QwRz-z0ksfZfgs")
